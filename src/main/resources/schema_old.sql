...
ALTER TABLE AVALUACIO ADD CONSTRAINT AVALUACIO_AMBIT_FK FOREIGN KEY ( ambit ) REFERENCES AMBIT ( id ) ;
...
ALTER TABLE FACTOR ADD CONSTRAINT FACTOR_VERSIO_MODEL_FK FOREIGN KEY ( versio_model ) REFERENCES VERSIO_MODEL ( id ) ;
...
ALTER TABLE PREGUNTA ADD CONSTRAINT PREGUNTA_ENTORN_FK FOREIGN KEY ( entorn ) REFERENCES ENTORN ( id ) ;
