...
ALTER TABLE EX_REFERENCIA ADD CONSTRAINT EX_REFERENCIA_PK PRIMARY KEY ( id ) ;

CREATE TABLE FACTOR
  ( id NUMBER NOT NULL , descripcio VARCHAR2 (500)
  ) ;
...
ALTER TABLE FACTOR_GRAVETAT ADD CONSTRAINT FACTOR_GRAVETAT_ENTORN_FK FOREIGN KEY ( entorn ) REFERENCES ENTORN ( id ) ;
