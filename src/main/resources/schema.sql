...
ALTER TABLE DIAGNOSTIC ADD CONSTRAINT DIAGNOSTIC_FACTOR_FK FOREIGN KEY ( factor ) REFERENCES RISC ( id ) ;
...
ALTER TABLE EXPEDIENT ADD CONSTRAINT EXPEDIENT_PROFESSIONAL_FK FOREIGN KEY ( professional ) REFERENCES PROFESSIONAL ( id ) ;

ALTER TABLE EXPEDIENT ADD CONSTRAINT EXPEDIENT_VALORACIO_FK FOREIGN KEY ( valoracio ) REFERENCES VALORACIO ( id ) ;
