...
public class DataBaseInit implements CommandLineRunner {
	...
	*/
	...
	public void run(String... args) throws Exception {
		...
		VersioModel versio = versioModelRepository.save(new VersioModel("111/AAAA/00",new Date()));
		...
		SituacioSocial situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Manca d'autonomia personal a les  activitats bàsiques de la vida diaria  (A.1)",
		...
		situacioSocial = situacioSocialRepository.save(
							new SituacioSocial (versio,"Manca d'autonomia personal a les  activitats bàsiques de la vida diaria  (A.1)",
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Habitatge insegur (H.3)","	",entornHabitatge,0.2d,0.4d,0.6d));
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Risc de pérdua o manca serveis/subministraments (H.5)","Risc de perdua o manca de subministraments (gas, aigua, electricitat), manca de parament bàsic o estris doméstics imprescindibles per satisfer les necessitats bàsiques de la unitat familiar. Inclou els risc de perdua per connexió il·legall."
													,entornHabitatge,0.2d,0.4d,0.6d));
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Sense ingressos (E.1)","Unitats familiars que no tenen ingressos o que no els acrediten de forma estable o regular. Es proposa Comptabilitzar en aquesta categoria aquelles unitats familiars on séhan identificat més de 6 étems dels qüestionari."
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Ingressos insuficients (E.2)","Unitats familiars que malgrat tenir uns ingressos tenen dificultats per cobrir determinades necessitats  dels seus integrants."
												,entornEconomic,1d,2d,3d));
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Administracié deficient (E.3)","Unitat familiar amb ingressos però que presenta dificultats per administrar el pressupost  i no prioritzar la cobertura de les necessitats bàsiques."
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Manca de competéncies relacionals a l'escola (ES.2)","Infant o adolescent que no s'adapta al sistema educatiu en l'etapa obligatéria i que presenta conductes disruptives al centre, amb els adults i/o amb els seus iguals."
													,entornEscolar,0.75d,1.5d,3d));		
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Escolaritat obligatéria inacabada (ES.3)","Menor en edat d'escolaritzacié obligatéria que no esté matriculat en cap centre, o que ha abandonat els estudis abans de la seva finalitzacié.",entornEscolar,0.75d,1.5d,3d));		
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Assetjament escolar (ES.5)","Infant o adolescent que esté patint Situacions habituals de violéncia física i psíquica en el marc de l'alumnatescola, o que séha iniciat en aquest marc encara que les actuacions es produeixin fora, per part dels seus companys i companyes, ja sigui en l'entorn escolar o fora déell"
																		,entornEscolar,0.75d,1.5d,3d));		
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Maltractament (F.1)","Situacions de maltractament que rep un menor d'edat,  adult o  persona gran, inclou vexacions de carécter fésic, psicolégic o emocional, aixé com les situacions de violéncia de génere. Inclou la sospita per part del professional o bé l'evidéncia que el maltractament s'esté produint.(Es consideren incloses en quest indicador totes les categories de maltractament relacionades al RUDEL)"
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Abés Sexual (F.2)","La participacié del nen/a i/o adolescent, adult o persona gran, en activitats sexuals que no esté en condicions de comprendre, que sén inapropiades per a la seva edat i el seu desenvolupament psicosexual, per a les quals és incapaé de donar el seu consentiment i que transgredeixen els tabés i les regles familiars i socials, aixé com les lleis vigents. En l'alumnatabés sexual existeixen dos factors clau: la coercié i la asimetria déedat o de moment evolutiu entre les persones implicades.",
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Dificultats per assumir responsabilitats familiars i socials (F.4)","Persones adultes que no sén capaces d'assumir adequadament les seves responsabilitats en el si del nucli familiar, respecte de les persones que en depenen legalment",entornFamiliar,0.43d,0.77d,2.5d));		
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Dificultats en les relacions familiars (F.7)","Persona que presenta dificultats de relacié i comportaments agressius amb un o més membres de la unitat de convivéncia.",entornFamiliar,0.43d,0.77d,2.5d));		
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Manca d'higiene o desordre al domicili (F.9)","Domicili que, degut al comportament déalgun del seus habitants, reuneix condicions déhabitabilitat però presenta un mal estat d'higiene general o uns elevats nivells de desordre i/o acumulacié d'estris o material divers, que dificulten la vida quotidiana de les persones que hi viuen. Inclou els casos vinculats a una malaltia mental (Séndrome de Diogenes o de Noé)",entornFamiliar,0.43d,0.77d,2.5d));		
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Dificultats en les relacions socials i a la participacié a la comunitat (S.1)","Persona amb dificultats per adaptar-se al seu medi social (aéllament, no respecta els límits normatius ni socials del seu entorn).",entornSocial,0.2d,0.5d,1.5d));		
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Rebuig social (S.2)","Persona socialment aéllada i/o rebutjada per raons físiques,  de génere, étnia, religió, orientació sexual, conducta o qualsevol altra raé.",entornSocial,0.2d,0.5d,1.5d));		
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Addiccions (S.3)","Persona que fa un és abusiu d'alguna substéncia téxica i/o que presenta conductes addictives (joc, noves tecnologies, etc.), que deriven en problemes familiars, econémics i/o laborals, i de salut.",entornSocial,0.2d,0.5d,1.5d));		
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Desatenció institucional  (S.4)","Persones que per la seva situació legal o adminsitrativa no tenen accés a determinats recursos de l'émbit de  salut, educacié i protecció social.",entornSocial,0.25d,0.25d,1d));		
		...
		situacioSocial = situacioSocialRepository.save(new SituacioSocial (versio,"Activitats marginals (S.5)","Treball no legalitzat, activitats marginals (Prostitució, venda ambulant il·legal, recollida de ferralla, altres).",entornSocial,0.2d,0.5d,1.5d));		
		...
		factorRepository.save(new Factor("La malaltia causa del déficit d'autonomia esté diagnosticada i en tractament",proteccioGravetat,entornAutonomia));
		factorRepository.save(new Factor("La persona té reconeguts el grau de discapacitat i / o dependéncia",proteccioGravetat,entornAutonomia));
		factorRepository.save(new Factor("La persona és usuéria d'un servei, recurs o prestacié  en funcié de la seva malaltia, discapacitat o situació de dependéncia",proteccioGravetat,entornAutonomia));
		factorRepository.save(new Factor("Hi ha una xarxa familiar i / o social de suport implicada en la cura",proteccioGravetat,entornAutonomia));
		factorRepository.save(new Factor("La persona segueix amb regularitat el tractament médic i/o té un hébits saludables per la seva situació de salut",proteccioGravetat,entornAutonomia));

		// Risc
		
		factorRepository.save(new Factor("Es preveu que el déficit d'autonomia de la persona séagreugi en un curt termini (durant l'any)",riscGravetat,entornAutonomia));
		factorRepository.save(new Factor("La malaltia causa del déficit d'autonomia no esté diagnosticada i en tractament",riscGravetat,entornAutonomia));
		factorRepository.save(new Factor("La persona no segueix amb regularitat el tractament médic prescrit i/o no té uns hébits saludables per la seva situació de salut",riscGravetat,entornAutonomia));
		factorRepository.save(new Factor("No existeix una xarxa familiar i / o social que séimpliqui en la cura",riscGravetat,entornAutonomia));
		factorRepository.save(new Factor("Cuidador / a habitual en risc o en situació de claudicacié",riscGravetat,entornAutonomia));
		factorRepository.save(new Factor("La situació i/o caracteréstiques del domicili agreugen el déficit d'autonomia  de les persones que hi viuen",riscGravetat,entornAutonomia));
		factorRepository.save(new Factor("La persona amb déficit d'autonomia té responsabilitats/carregues familiars",riscGravetat,entornAutonomia));
		
		
		// Proteccio
		factorRepository.save(new Factor("Una o més persones de la familia disposa d'ingressos estables (pensions, prestacions, rendes, etc.).",proteccioGravetat,entornHabitatge));
		factorRepository.save(new Factor("Una o més persones de la familia disposa d'ingressos estables (pensions, prestacions, rendes, etc.).",proteccioGravetat,entornEconomic));
		factorRepository.save(new Factor("Una o més persones de la familia disposa d'estalvis",proteccioGravetat,entornHabitatge));
		factorRepository.save(new Factor("Una o més persones de la familia disposa d'estalvis",proteccioGravetat,entornEconomic));
		factorRepository.save(new Factor("Una o més persones de la familia disposa de patrimoni a part de la primera residéncia",proteccioGravetat,entornHabitatge));
		factorRepository.save(new Factor("Una o més persones de la familia disposa de patrimoni a part de la primera residéncia",proteccioGravetat,entornEconomic));
		factorRepository.save(new Factor("Una o més persones de la familia disposa de treball estable.",proteccioGravetat,entornHabitatge));
		factorRepository.save(new Factor("Una o més persones de la familia disposa de treball estable.",proteccioGravetat,entornEconomic));
		factorRepository.save(new Factor("Existeix xarxa familiar o relacional disposada a oferir suport econémic",proteccioGravetat,entornHabitatge));
		factorRepository.save(new Factor("Existeix xarxa familiar o relacional disposada a oferir suport econémic",proteccioGravetat,entornEconomic));
		factorRepository.save(new Factor("En cas de separacié o divorci hi ha conveni regulador i es compleixen els seus termes",proteccioGravetat,entornHabitatge));
		factorRepository.save(new Factor("En cas de separacié o divorci hi ha conveni regulador i es compleixen els seus termes",proteccioGravetat,entornEconomic));
		factorRepository.save(new Factor("La persona té una bona predisposicié per formar-se i/o treballar",proteccioGravetat,entornHabitatge));
		factorRepository.save(new Factor("La persona té una bona predisposicié per formar-se i/o treballar",proteccioGravetat,entornEconomic));
		factorRepository.save(new Factor("Es disposa déun habitatge habitual pel qual no séha déassumir cap despesa o és un habitatge social",proteccioGravetat,entornHabitatge));
		factorRepository.save(new Factor("Es disposa déun habitatge habitual pel qual no séha déassumir cap despesa o és un habitatge social",proteccioGravetat,entornEconomic));


		// Risc
		factorRepository.save(new Factor("Existeix un impagament de pensions de manutencié i la corresponent demanda judicial",riscGravetat,entornHabitatge));
		factorRepository.save(new Factor("Existeix un impagament de pensions de manutencié i la corresponent demanda judicial",riscGravetat,entornEconomic));
		factorRepository.save(new Factor("Existeixen responsabilitats i cérregues familiars que agreugen la manca de recursos materials/instrumentals",riscGravetat,entornHabitatge));
		factorRepository.save(new Factor("Existeixen responsabilitats i cérregues familiars que agreugen la manca de recursos materials/instrumentals",riscGravetat,entornEconomic));
		factorRepository.save(new Factor("Hi ha un endeutament creixent i inassolible amb els recursos disponibles",riscGravetat,entornHabitatge));
		factorRepository.save(new Factor("Hi ha un endeutament creixent i inassolible amb els recursos disponibles",riscGravetat,entornEconomic));
		
		
		// Proteccio
		factorRepository.save(new Factor("La persona mostra una vinculacié relacional positiva amb la familia extensa o les seves xarxes déamics i relacions",proteccioGravetat,entornEscolar));
		factorRepository.save(new Factor("La persona mostra una vinculacié relacional positiva amb la familia extensa o les seves xarxes déamics i relacions",proteccioGravetat,entornFamiliar));
		factorRepository.save(new Factor("La persona esté vinculada i participa activament amb la comunitat, entitats o associacions del seu entorn",proteccioGravetat,entornEscolar));
		factorRepository.save(new Factor("La persona esté vinculada i participa activament amb la comunitat, entitats o associacions del seu entorn",proteccioGravetat,entornFamiliar));
		factorRepository.save(new Factor("Existeix xarxa familiar o relacional disposada a oferir suport i acompanyament",proteccioGravetat,entornEscolar));
		factorRepository.save(new Factor("Existeix xarxa familiar o relacional disposada a oferir suport i acompanyament",proteccioGravetat,entornFamiliar));
		factorRepository.save(new Factor("En el cas d'inféncia que el nen / a manté relacié afectiva amb els adults de referéncia i iguals",proteccioGravetat,entornEscolar));
		factorRepository.save(new Factor("En el cas d'inféncia que el nen / a manté relacié afectiva amb els adults de referéncia i iguals",proteccioGravetat,entornFamiliar));
		factorRepository.save(new Factor("En el cas d'inféncia que el nen / a mostra una autonomia personal adequada per a la seva edat",proteccioGravetat,entornEscolar));
		factorRepository.save(new Factor("En el cas d'inféncia que el nen / a mostra una autonomia personal adequada per a la seva edat",proteccioGravetat,entornFamiliar));
		factorRepository.save(new Factor("En el cas d'inféncia que el nen / a participa en activitats fora de l'entorn familiar o escolar",proteccioGravetat,entornEscolar));
		factorRepository.save(new Factor("En el cas d'inféncia que el nen / a participa en activitats fora de l'entorn familiar o escolar",proteccioGravetat,entornFamiliar));
		factorRepository.save(new Factor("La persona/familia és usuéria de recursos/serveis adreéats a cobrir la necessitat en l'àmbit relacional (escolar, familiar o comunitari) ",proteccioGravetat,entornEscolar));
		factorRepository.save(new Factor("La persona/familia és usuéria de recursos/serveis adreéats a cobrir la necessitat en l'àmbit relacional (escolar, familiar o comunitari) ",proteccioGravetat,entornFamiliar));


		// Risc
		factorRepository.save(new Factor("Existeix una xarxa social (veéns, amics, familia extensa..) que exerceix una influéncia negativa",riscGravetat,entornEscolar));
		factorRepository.save(new Factor("Existeix una xarxa social (veéns, amics, familia extensa..) que exerceix una influéncia negativa",riscGravetat,entornFamiliar));
		factorRepository.save(new Factor("Sospita o malaltia mental diagnosticada que agreugen la situació ",riscGravetat,entornEscolar));
		factorRepository.save(new Factor("Sospita o malaltia mental diagnosticada que agreugen la situació ",riscGravetat,entornFamiliar));
		factorRepository.save(new Factor("Existeix una problemética de salut no diagnosticada que agreuja la situació",riscGravetat,entornEscolar));
		factorRepository.save(new Factor("Existeix una problemética de salut no diagnosticada que agreuja la situació",riscGravetat,entornFamiliar));
		factorRepository.save(new Factor("En el cas d'inféncia que el nen / a no manté relacié afectiva amb els adults de referéncia i iguals",riscGravetat,entornEscolar));
		factorRepository.save(new Factor("En el cas d'inféncia que el nen / a no manté relacié afectiva amb els adults de referéncia i iguals",riscGravetat,entornFamiliar));
		factorRepository.save(new Factor("En el cas d'inféncia que el nen / a no mostra una autonomia personal adequada per a la seva edat",riscGravetat,entornEscolar));
		factorRepository.save(new Factor("En el cas d'inféncia que el nen / a no mostra una autonomia personal adequada per a la seva edat",riscGravetat,entornFamiliar));
		factorRepository.save(new Factor("En el cas d'inféncia que el nen / a no participa en activitats fora de l'entorn familiar o escolar",riscGravetat,entornEscolar));
		factorRepository.save(new Factor("En el cas d'inféncia que el nen / a no participa en activitats fora de l'entorn familiar o escolar",riscGravetat,entornFamiliar));
		...
		factorRepository.save(new Factor("La persona i / o familia té consciencia i accepta  les dificultats / malaltia causants de la seva situació",proteccioGravetat,entorn));
		factorRepository.save(new Factor("La persona i / o familia accepta el suport i l'orientació professional",proteccioGravetat,entorn));
		factorRepository.save(new Factor("La persona coneix i té una actitud proactiva i participativa envers el sistema i les xarxes de protecció",proteccioGravetat,entorn));
		factorRepository.save(new Factor("La persona i / o familia no té consciencia i/o no accepta  les dificultats/malaltia causants de la seva situació",riscGravetat,entorn));
		factorRepository.save(new Factor("La persona i / o familia no accepta el suport i l'orientació professional",riscGravetat,entorn));
		factorRepository.save(new Factor("La persona no té una actitud activa i ni participativa envers el sistema i les xarxes de protecció i/o té una posicionament victimista respecte els sistemes de protecció",riscGravetat,entorn));
		factorRepository.save(new Factor("Composicié familiar vulnerable (monoparental, families nombroses de categoria especial)",riscGravetat,entorn));
